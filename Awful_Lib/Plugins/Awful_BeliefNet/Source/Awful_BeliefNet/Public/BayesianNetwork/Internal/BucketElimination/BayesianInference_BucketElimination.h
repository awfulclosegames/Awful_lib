...
#include "BayesianNetwork/Internal/BucketElimination/Utilities/NodeAccessor.h"
...
namespace Awful_BeliefNet
{
	...
	{
		class AWFUL_BBN_API BayesianInference_BucketElimination : private BBN_Accessor
		{
