...
namespace Awful_BeliefNet
{
	...
	class AWFUL_BBN_API BBN_Mutator : protected BBN_Accessor
	{
	...
	protected:
		...
		void RenameNode(IdentifierType aOldID, IdentifierType aNewID) { return mBBN.RenameNode(aOldID, aNewID); }
