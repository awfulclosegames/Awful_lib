...
#include "AI_Common/Utilities/PackedIndexRemapping.h"
...
namespace Awful_BeliefNet
{
	...
	namespace BucketElimination
	{
		...
		class AWFUL_BBN_API BayesianBucket
		{
		public:
			...
			BayesianBucket(BayesianBucket&& aRHS) noexcept;

			BayesianBucket& operator=(BayesianBucket& aRHS);
			BayesianBucket& operator=(BayesianBucket&& aRHS) noexcept;
			...
			void FactorByBelief(bool aIsBelieved) { mFactor.FactorByBelief(aIsBelieved); }
