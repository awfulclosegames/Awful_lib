...
#include "AI_Common/Utilities/Pooling/BasicPool.h"
...
namespace Awful
{
	...
	protected:
		using PoolBlock = typename BASE::PoolBlock;
		using PoolStorageEntry = typename BASE::PoolStorageEntry;
...
{
	std::size_t operator()(const typename Awful::ChunkedPoolImplementation<PoolType, AllocationBlockSize, ChunkStorageProvider>::ItemHandleImplementation& k) const noexcept
	{
...
{
	std::size_t operator()(const typename Awful::ChunkedPoolImplementation<PoolType, AllocationBlockSize, ChunkStorageProvider>::ItemHandleImplementation& A, const typename Awful::ChunkedPoolImplementation<PoolType, AllocationBlockSize, ChunkStorageProvider>::ItemHandleImplementation& B) const noexcept
	{
